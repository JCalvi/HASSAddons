...
rem docker build -t jcrfc/hass-actronque-armv7:latest -t jcrfc/hass-actronque-armv7:2025.1.0 . --platform linux/arm/v7
rem docker push jcrfc/hass-actronque-armv7:latest
rem docker push jcrfc/hass-actronque-armv7:2025.1.0
